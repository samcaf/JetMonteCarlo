...
_test_params=( --fixed_coupling True --type quark --obs LL --split LL --nmc 1e4 --nshowers 5e2 --nbins 5e2 --cutoff 1e-15 )
_test_params_munp=( --fixed_coupling False --type quark --obs MLL --split MLL --nmc 1e4 --nshowers 5e2 --nbins 5e2 --cutoff 1e-15 )
