...
printf 'Running scripts/test_script_1.sh ('"$0"') with options:'"\n"
printf '%q ' "$args"
printf "\n\n"
...
python3 jetmontecarlo/tests/test_scripts/sample_program.py
